...
class MainPage(PageBase):
    ...
    def set_departure_date(self): #if there's time can be done to take a desired date and press the right arrow until finds the proper month
        ...
        arrow_element = self.wait_for_element(By.XPATH, "//button[contains(@class, 'arrow') and contains(@class, 'right')]")
        arrow_element.click()
